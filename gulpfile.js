...
(function() {
    ...
    =============================
    */
    var File_Name = 'html-tokenmart.zip';
    var CSS_Files = [  
    ...
    var Production_CSS_Files = [ 
        ...
        './dist/production/assets/css/nice-select.css',
    ...
    var Production_JS_Files = [ 
        ...
        './dist/production/assets/js/swiper-bundle.min.js',     
        './dist/production/assets/js/aos.js',     
        ...
        './dist/production/assets/js/jquery.nice-select.min.js',
