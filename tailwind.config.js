...
module.exports = {
  ...
  theme: {
      ...
      boxShadow: {
        DEFAULT: '0px 5px 20px rgba(73, 116, 230, 0.04), 0px 5px 15px rgba(0, 0, 0, 0.035), 0px 3.39155px 7.58112px rgba(0, 0, 0, 0.0282725), 0px 1.4113px 3.15467px rgba(185, 202, 248, 0.06)',  
